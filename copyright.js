(function(){ //let's put this in a function, YOLO.
    ...
    var owners = [ //list owners of the copyright here. This is a list of strings. Each string is a copyright holder. The first one is the web designer, the rest are the copyright holders.
        'Cybermissions'
    ]; 
